  ...
  */
  ...
  CLI = (function() {
    ...
    function CLI() {
      ...
      this.argv = optimist.usage("Usage: " + exports.name).alias('c', 'config').describe('c', 'The configuration file to use')["default"]('c', "/etc/ldapless.json").alias('a', 'admin_secret').describe('a', 'The secret for the admin user')["default"]('a', "admin").alias('l', 'loglevel').describe('l', 'Set the log level (debug, info, warn, error, fatal)')["default"]('l', 'warn').alias('p', 'port').describe('p', 'Run the api server on the given port')["default"]('p', 3000).alias('h', 'help').describe('h', 'Shows this message')["default"]('h', false).argv;
      this.configure();
